        ...
        <div className="max-w-4xl mx-auto glass-card p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            <p className="text-lg text-white/90">
              ...
              businesses were either overpaying for software or getting
              systems that could not scale beyond basic use.
            </p>

            <p>
              We built this company to close that gap. Not as another agency,
              but as an engineering-first team focused on building systems
              that actually survive real usage - traffic spikes, security
              threats, and business growth pressure.
            </p>
            ...
            <p>
              ...
              applications, and connected devices - building infrastructure
              that powers real operations, not just presentations.
            </p>
            <p>
              This is not a traditional agency structure. We operate as a
              small, engineering-heavy unit where every system is designed
              with ownership, performance, and long-term maintainability in
              mind.
            </p>

            <p>
              The goal is simple: build systems that behave like
              infrastructure, not prototypes — stable under load, secure by
              design, and built to evolve with the business.
            </p>
          </div>
        </div>
      </section>
