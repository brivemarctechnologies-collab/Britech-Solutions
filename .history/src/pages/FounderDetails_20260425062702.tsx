  ...
  return (
    <div className="min-h-screen bg-deep-black pt-24">
      ...
      <section className="section-container">
        ...
        {/* ===== DETAILS SECTION ===== */}
          <section className="section-container mt-12 space-y-10">
          {/* ===== RESPONSIBILITIES ===== */}
<div className="glass-card p-6">
...
{ /* ======= TECH STACK ======== */}
  <div className="glass-card p-6">
    <h3 className="text-xl text-white mb-3">Tech Stack</h3>
    <div className="flex flex-wrap gap-2">
      {founder.techStack.map((tech, i) => (
        <span
          key={i}
          className="px-3 py-1 bg-gold-400/10 border border-gold-400/30 rounded-full text-sm text-gold-300"
        >
          {tech}
        </span>
      ))}
          ...
          {/* ===== NOTABLE WORK ===== */}
<div className="glass-card p-6">
  <h3 className="text-xl text-white mb-3">Notable Work</h3>
  <ul className="space-y-2">
    {founder.notableWork.map((work, i) => (
      <li key={i} className="text-gray-400">
        • {work}
      </li>
    ))}
          ...
          {/* ===== PHILOSOPHY ===== */}
<div className="glass-card p-6 border-l-2 border-gold-400">
  <h3 className="text-xl text-white mb-3">Philosophy</h3>
            ...
            <div className="flex gap-4 mt-4">
              {founder.links.linkedin && (
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-gray-300 hover:text-gold-400 transition"
                >
