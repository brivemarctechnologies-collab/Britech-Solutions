        ...
        >
          <div className="max-w-4xl mx-auto glass-card p-8 md:p-12">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                Brivemarc Technologies was founded after recognizing a
                consistent gap in how digital systems are built for small and
                growing businesses in Kenya. Most solutions were either too
                expensive, too generic, or poorly optimized for real operational
                use. Businesses were forced to choose between affordability and
                quality - rarely getting both. We started with a simple goal:
                build systems that are not just functional, but practical,
                scalable, and secure from day one. Over time, this evolved into
                a focused engineering-driven agency specializing in web systems,
                mobile applications, and intelligent automation. Every project
                we take on is designed with long-term maintainability and
                real-world performance in mind, not just short-term delivery.
                Today, Brivemarc Technologies operates as a small but highly
                technical team focused on delivering production-ready systems
