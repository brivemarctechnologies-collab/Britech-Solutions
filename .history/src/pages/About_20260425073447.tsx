...
const lineReveal = {
  hidden: { scaleX: 0 },
  show: { scaleX: 1, transition: { duration: 0.8, ease: "easeInOut" as const } },
};
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {founders.map((founder) => (
              ...
              >
                ...
                <span className="inline-flex items-center text-xs font-bold text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
