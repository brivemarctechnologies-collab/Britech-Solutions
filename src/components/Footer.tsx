...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        { icon: FaLinkedin, url: 'https://linkedin.com/company/brivemarc-technologies' },
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            {footerLinks.services.map((link) => (
                                <li key={link.name}>
                                    <a href={link.href} className="text-gray-400 hover:text-gold-400">
                                        {link.name}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            {footerLinks.company.map((link) => (
                                <li key={link.name}>
                                    <Link to={link.href} className="text-gray-400 hover:text-gold-400">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
